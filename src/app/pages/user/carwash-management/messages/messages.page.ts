...
export class MessagesPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.queryParams.subscribe((param) => {
      ...
      this.propID = param.carwashID;
      this.sendTo = param.sendTo;
      this.carwashName = param.carwashName;
      this.totalPrice = param.carPrice;
      this.washType = param.washType,
      this.carModel = param.carModel
    });
  ...
  requestAppointment() {
    ...
    this.text = 'Appointment request, Date: ' + this.date + ' ' + this.time  
    +' ' + 'the requird wash is :' + this.washType +' '+ 'Car model is : '+this.carModel
     + ' '+ 'Total price for the service is :'+ ' '+this.totalPrice ;
    this.sendMessage();
